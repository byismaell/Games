...
cf = pygame.image.load(os.path.join("assets","img","campodeforça.png")).convert_alpha()
cf = pygame.transform.scale(cf,(180,120))
cf.set_alpha(110)
metoros_list = []
...
#Capturando o Retangulo 
cfRec = cf.get_rect(center=(600,520))
bg1 = pygame.image.load(os.path.join("assets","img","espaco.png")).convert()
bgR1 = bg1.get_rect(center=((width/2,(height/2))))
...
while loop:
   ...
   # entrada do mouse campo de força    
    cfRec.center = pygame.mouse.get_pos()
    ...
    #utilizando o retangulo para poscionar o campo de força
    display.blit(cf, cfRec)
    ...
    for meteoro_tupla in metoros_list:
        ...
        if cfRec.colliderect(rec_meteoro):
            pygame.quit()
            sys.exit()
